...
public abstract class Client
{
	...
	public int getXid() throws RemoteException {
		...
		try {
			switch (cmd) {
				...
				case Analytics: {
					...
					System.out.println("Items with low remaining quantities:");
					System.out.println(m_resourceManager.getAnalytics());
					break;
				}
				case Summary: {
					checkArgumentsCount(1, arguments.size());
					System.out.println("Summary for items reserved by each customer:");
					System.out.println(m_resourceManager.getSummary());
					break;
				}
				case Start: {
					checkArgumentsCount(1, arguments.size());
					int xid = m_resourceManager.start();
					System.out.println("Start transaction: " + xid);
					break;
				}
				case Commit: {
					checkArgumentsCount(2, arguments.size());
					System.out.println("Committing transaction " + arguments.elementAt(1));
				...
				case Shutdown: {
					...
					if (m_resourceManager.shutdown()) {
						System.out.println("Shutdown is successful");
					} else {
						System.out.println("Shutdown is interrupted");
					}
					break;
				}
				case Quit:
